...
object QualifiedName {
  def apply(str: String): QualifiedName = QualifiedName(
    IArray.fromArray(str.split("\\.")).map(Name(_))
  )
  ...
  val Runtime: QualifiedName = QualifiedName(
    IArray(Name("org"), Name("scalablytyped"), Name("runtime"))
  )
  ...
  val BOOLEAN_LITERAL: QualifiedName = QualifiedName(
    IArray(Name.BOOLEAN_LITERAL)
  )
  ...
  // Additional type constants for TypeRef
  val Char: QualifiedName    = scala + Name("Char")
  ...
  class StdNames(outputPkg: Name) {
    ...
    val HTMLElementTagNameMap: QualifiedName =
      lib + Name("HTMLElementTagNameMap")
  ...
  def Instantiable(arity: Int): QualifiedName =
    Runtime + Name(s"Instantiable$arity")
  def FunctionArity(isThis: Boolean, arity: Int): QualifiedName =
    scala_js + Name.FunctionArity(isThis, arity)
  def ScalaFunctionArity(arity: Int): QualifiedName =
    scala + Name.FunctionArity(isThis = false, arity)
