...
object Selection {
  ...
  final case class AllExcept[T: Ordering](values: SortedSet[T])
      extends Selection[T]
  ...
  final case class And[T](_1: Selection[T], _2: Selection[T])
      extends Selection[T]

  final case class Or[T](_1: Selection[T], _2: Selection[T])
      extends Selection[T]
